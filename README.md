...
the item link into chat. Position, size, scale, history limit, and recent rolls
are stored account-wide. An expanded active roll stays open when its winner is
announced.
